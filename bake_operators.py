    ...
    def _bake_action(self, context, *source_bones):
        ...
        baked_action = bpy_extras.anim_utils.bake_action(
            ...
            bake_options = bpy_extras.anim_utils.BakeOptions(
                ...
                do_constraint_clear=False, # Do not clear constraints after baking
                do_parents_clear=False,    # Do not clear parent relationships
                do_clean=False,            # Do not remove redundant keyframes
                do_location=True,          # Include location in the bake
                do_rotation=True,          # Include rotation in the bake
                do_scale=True,             # Include scale in the bake
                do_bbone=False,            # Exclude B-Bone properties
                do_custom_props=False,     # Exclude custom properties
            )
            #only_selected=True,
            #do_pose=True,
            #do_object=False,
